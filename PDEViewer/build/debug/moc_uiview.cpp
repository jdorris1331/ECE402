...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UIView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 8)
    ...
    "UIView\0on_slideOmega_sliderMoved\0\0"
    "position"
};
...
void UIView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UIView *_t = static_cast<UIView *>(_o);
        switch (_id) {
        case 0: _t->on_slideOmega_sliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject UIView::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_UIView.data,
      qt_meta_data_UIView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UIView.stringdata))

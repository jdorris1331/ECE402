...
QT_MOC_LITERAL(5, 28, 3)
    ...
    "SliderBox\0moved\0\0pos\0update\0val"
};
...
void SliderBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SliderBox::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SliderBox::moved)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SliderBox::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_SliderBox.data,

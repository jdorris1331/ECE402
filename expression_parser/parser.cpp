    ...
    if (token_type == VARIABLE)
    {
        ...
        if (strcmp(token, "=") == 0)
        {
            ...
            if(user_var->exist(token_now)) {
              cout << "changing " << token_now << " to " << ans->val << endl;
...
VAR* Parser::parse_level8()
{
    ...
    { 
        ...
        temp_minus->val=-1.0;
        //*******maybe delete old ret_var after?
        ret_var = mult(ret_var,temp_minus);
        delete temp_minus;
    }
    else
    {
